...
const address = "0x6bb45cEAC714c52342Ef73ec663479da35934bf7"
const contract = new web3.eth.Contract(abi, address)
contract.methods.totalSupply().call((err, result) => { console.log(result) })
contract.methods.name().call((err, result) => { console.log(result) })
contract.methods.symbol().call((err, result) => { console.log(result) })
contract.methods.balanceOf('0x2c9acd7A958C129d472155ab40ae40807B2e5f9B').call((err, result) => { console.log(result) })
*/
...
web3.eth.getTransactionCount(account, (err, txCount) => {
  ...
  const txObject = {
    ...
    gasPrice: web3.utils.toHex(web3.utils.toWei('10', 'gwei')),
    to: contractAddress,
    data: contract.methods.deposit(14, 0).encodeABI()
  }
